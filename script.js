...
function select(guessedTrue) {
  ...
  // if guessed True then push true into player guess array, else push false into player guess array
  return guessedTrue
...
function createEquations() {
  ...
  // check shuffle.js file for sfuffle array function
...
function countdownStart() {
  ...
  // Same functionality as above but this is fragile code
